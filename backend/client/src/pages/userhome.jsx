...
import aiImageAnalysisImage from '../assets/image.jpg';
...
function HomePage() {
  ...
  const services = [
    ...
    {
      title: "Video calling",
      description: "Instant vedio calling with our pet care experts for your queries.",
    ...
    },
    {
      ...
      description: "To provide the drug intake reminders.",
      image: aiImageAnalysisImage,
       link: "https://medicalreminder-d93e0c.netlify.app/"
    }
  ];
      ...
      >
        <div className="text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-white leading-tight">
            Your Pet's Health, <span className="text-green-300">Our Priority</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-white mb-6 sm:mb-8 opacity-90 px-2 sm:px-0">
            Compassionate care for your furry family members with our expert veterinary services.
          </p>
